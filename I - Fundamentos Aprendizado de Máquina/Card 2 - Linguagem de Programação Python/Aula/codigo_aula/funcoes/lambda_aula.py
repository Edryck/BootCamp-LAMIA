...
# Lambda que vai pegar as notas dos alunos
obter_nota = lambda aluno: aluno['nota']
# Função lambda para somar as notas
somar = lambda a, b: a + b
# Filtra os alunos aprovados
alunos_aprovados = filter(aluno_aprovado, alunos)
# Pega a partir do map as notas dos aprovados
notas_alunos_aprovados = map(obter_nota, alunos_aprovados)
# Usa o reduce para somar tudo as notas dos aprovados
